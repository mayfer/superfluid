    ...
    //				camera.applyMatrix( camera_rotation );
                    ...
                    for ( var jj = 0; jj < pointclouds.length; jj ++ ) {
                        ...
                        for ( var deg = 0; deg <= Math.PI*2; deg += degree) {
                                ...
                                var extension2 = 
                                    Math.pow(Math.max(0, Math.sin(counter/100 + deg)), 3) * 
                                    Math.sin(jj*Math.PI/2 + deg  * 24) / 15;
                                var extension_z2 = 
                                    Math.pow(Math.max(0, Math.sin(counter/100 + deg)), 3) * 
                                    Math.cos(jj*Math.PI/2 + deg * 24)  / 15;


                                var x = Math.sin(deg) * (radius) + Math.sin(deg) * extension;
                                var y = Math.cos(deg) * (radius) + Math.cos(deg) * extension + Math.sin(deg)*extension2;
                                var multiplier = 1;

                                //var curvature = Math.sin(deg*10) * Math.pow(multiplier/2, 2) * Math.cos(counter/400) / 200;

                                var z = extension_z + Math.cos(deg) * extension2
